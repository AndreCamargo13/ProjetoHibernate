...
public class Pagamento implements java.io.Serializable {
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "codcurso", column = @Column(name = "CODCURSO", nullable = false, precision = 22, scale = 0)) })
	...
	public String toString() {
		return "Pagamento [cpf="+id.getCpf()+" codcurso="+id.getCodcurso()+" data_inscricao="+datainscricao+"]";
	}

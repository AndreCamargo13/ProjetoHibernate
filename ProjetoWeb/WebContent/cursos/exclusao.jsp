          ...
          <div class="col-md-12">
            <form class="form-horizontal" role="form" action="http://localhost/ProjetoWeb/Controlador" method="post">
              <div class="form-group">
                <div class="col-sm-3">
                  <label for="inputCPF" class="control-label">Informar o CURSO a ser EXCLUIDO:</label>
                </div>
                <div class="col-sm-9">
                  <input type="number" name="codcurso" class="form-control" id="inputCPF" placeholder="CURSO" required>
                </div>
              </div>
